# Task 04 - Sidecar prototype option

## Objective

Prototype or design a sidecar mode where llama.cpp verifies tokens while an external DFlash runtime proposes draft blocks.
...
```text
phase-4: task 04 - sidecar prototype option
```
