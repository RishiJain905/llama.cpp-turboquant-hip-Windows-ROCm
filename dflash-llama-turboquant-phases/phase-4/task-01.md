# Task 01 - DFlash model architecture study

## Objective

Inspect z-lab DFlash model files and identify whether the draft models can be represented in GGUF/ggml or need a sidecar runtime.
...
```text
phase-4: task 01 - dflash model architecture study
```
