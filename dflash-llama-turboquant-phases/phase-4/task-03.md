# Task 03 - GGUF conversion feasibility

## Objective

Investigate whether `convert_hf_to_gguf.py` can be extended for DFlash draft model architecture or whether a new converter is needed.
...
```text
phase-4: task 03 - gguf conversion feasibility
```
