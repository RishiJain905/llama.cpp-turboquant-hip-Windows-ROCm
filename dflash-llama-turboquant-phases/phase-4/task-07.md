# Task 07 - GitHub release package

## Objective

Create a public README, architecture diagram, benchmark table, limitations section, and honest claims. Suggested wording: `experimental DFlash-style speculative decoding for llama.cpp TurboQuant`.
...
```text
phase-4: task 07 - github release package
```
