# Task 02 - Compatibility matrix

## Objective

Create a matrix for supported target models, matching DFlash draft models, tokenizer compatibility, block size, backend assumptions, and whether conversion looks possible.
...
```text
phase-4: task 02 - compatibility matrix
```
