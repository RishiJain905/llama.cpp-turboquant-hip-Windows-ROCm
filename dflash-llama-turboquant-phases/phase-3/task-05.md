# Task 05 - Metrics extension

## Objective

Add DFlash-style metrics: proposed blocks, accepted blocks, accepted tokens per block, fallback count, draft time, verify time, and net speedup.
...
```text
phase-3: task 05 - metrics extension
```
