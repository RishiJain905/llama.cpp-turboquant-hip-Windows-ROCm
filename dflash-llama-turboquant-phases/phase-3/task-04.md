# Task 04 - Target verifier reuse

## Objective

Route stub block drafts into the existing target verification path so accept/reject accounting works without a real DFlash model.
...
```text
phase-3: task 04 - target verifier reuse
```
