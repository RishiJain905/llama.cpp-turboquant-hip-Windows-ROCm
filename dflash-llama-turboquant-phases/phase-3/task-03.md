# Task 03 - Stub block drafter

## Objective

Implement a deterministic stub drafter that emits safe candidate blocks from known token history or simple n-gram logic, mainly to prove the interface.
...
```text
phase-3: task 03 - stub block drafter
```
