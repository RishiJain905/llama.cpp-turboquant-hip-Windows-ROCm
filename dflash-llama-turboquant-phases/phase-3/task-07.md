# Task 07 - Phase 3 benchmark report

## Objective

Benchmark the stub/block path against baseline speculative decoding. Even 0% speedup is acceptable if the architecture and metrics are reliable.
...
```text
phase-3: task 07 - phase 3 benchmark report
```
