# Task 06 - Safety and correctness tests

## Objective

Add tests or scripted checks showing that experimental mode produces valid output, falls back safely, and never bypasses target verification.
...
```text
phase-3: task 06 - safety and correctness tests
```
