# Task 02 - speculative.cpp code walkthrough

## Objective

Read `examples/speculative/speculative.cpp` and map the target model load, draft model load, prompt eval, draft loop, target verification, accept/reject logic, and final metrics.
...
```text
phase-2: task 02 - speculative.cpp code walkthrough
```
