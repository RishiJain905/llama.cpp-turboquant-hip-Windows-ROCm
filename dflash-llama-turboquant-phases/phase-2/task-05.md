# Task 05 - TurboQuant interaction test

## Objective

Repeat speculative tests with your TurboQuant compression settings and compare whether TQ changes acceptance rate, decode speed, or memory behavior.
...
```text
phase-2: task 05 - turboquant interaction test
```
