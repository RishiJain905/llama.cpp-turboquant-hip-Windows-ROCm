# Task 03 - Normal draft model test

## Objective

Run existing draft-model speculation with a compatible smaller GGUF draft model and capture accept rate, tokens/sec, and correctness notes.
...
```text
phase-2: task 03 - normal draft model test
```
