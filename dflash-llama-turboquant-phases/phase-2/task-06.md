# Task 06 - Speculative bottleneck report

## Objective

Write a report explaining where time is spent: draft model forward pass, target verification batch, memory/KV operations, sampling, or synchronization.
...
```text
phase-2: task 06 - speculative bottleneck report
```
