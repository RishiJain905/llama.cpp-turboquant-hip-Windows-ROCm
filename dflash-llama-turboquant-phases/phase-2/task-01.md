# Task 01 - Speculative docs map

## Objective

Summarize `docs/speculative.md` and list every supported server speculative mode, including draft-model and n-gram modes.
...
```text
phase-2: task 01 - speculative docs map
```
