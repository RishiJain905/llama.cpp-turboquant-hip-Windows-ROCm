# Task 04 - Draftless n-gram test

## Objective

Benchmark `ngram-simple`, `ngram-map-k`, `ngram-map-k4v`, and `ngram-mod` where supported, especially on code rewrite and repetitive prompts.
...
```text
phase-2: task 04 - draftless n-gram test
```
