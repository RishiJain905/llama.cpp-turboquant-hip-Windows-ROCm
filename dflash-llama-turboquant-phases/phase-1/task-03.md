# Task 03 - Baseline prompt set

## Objective

Create a small prompt suite covering short answer, code generation, summarization, long context, and repetitive text/code rewrite cases.
...
```text
phase-1: task 03 - baseline prompt set
```
