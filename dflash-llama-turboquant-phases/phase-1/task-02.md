# Task 02 - Build verification script

## Objective

Create a Windows-friendly script that verifies `llama-server.exe`, `llama-cli.exe`, and any relevant example binaries exist after build.
...
```text
phase-1: task 02 - build verification script
```
