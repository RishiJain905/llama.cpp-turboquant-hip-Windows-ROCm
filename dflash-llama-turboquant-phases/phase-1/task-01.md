# Task 01 - Repo and branch snapshot

## Objective

Document the exact branch, commit, build preset, compiler, ROCm/HIP version, GPU, models, and TurboQuant settings currently known to work.
...
```text
phase-1: task 01 - repo and branch snapshot
```
